...
const MistBackground: React.FC = () => {
    ...
    `;
      ...
      void main() {
          ...
          // Lighter dark base with softer pink mist
          vec3 baseColor = vec3(0.04, 0.02, 0.04);
          vec3 mistColor = vec3(0.20, 0.10, 0.15);
          vec3 accentColor = vec3(0.35, 0.15, 0.25);
          ...
          color += mouseGlow * 0.04 * vec3(1.0, 0.4, 0.6);

          // Balanced post-processing - less dark
          color = pow(color, vec3(1.05)) * 1.1;
